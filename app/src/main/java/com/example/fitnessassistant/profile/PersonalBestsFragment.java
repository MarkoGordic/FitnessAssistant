    ...
    public void updateStepsData(View view) {
        ...
        if(view != null) {
            ...
            if(streakDateStart == null || streakDateEnd == null || maxStreak == 0) {
                ...
                ((TextView) view.findViewById(R.id.achievementDate2)).setText(String.format("%02d %s %d - %02d %s %d", startDay, getMonthShort(requireActivity(), startMonth), startYear, endDay, getMonthShort(requireActivity(), endMonth), endYear));
            ...
            if(maxStepsDate == null || maxSteps == 0) {
                ...
                ((TextView) view.findViewById(R.id.achievementDate1)).setText(String.format("%02d %s %d", day, getMonthShort(requireActivity(), month), year));
        ...
        if(view != null && getActivity() != null) {
            ...
            if(!data.isEmpty()) {
                ...
                if(maxDistanceBikeDate == null || maxDistanceBike == 0f) {
                    ...
                    ((TextView) view.findViewById(R.id.achievementDate5)).setText(String.format("%02d %s %d", cal.get(Calendar.DAY_OF_MONTH), getMonthShort(requireActivity(), cal.get(Calendar.MONTH) + 1), cal.get(Calendar.YEAR)));
                    if(UnitPreferenceFragment.getDistanceUnit(getActivity()).equals(UnitPreferenceFragment.DISTANCE_UNIT_MILE))
