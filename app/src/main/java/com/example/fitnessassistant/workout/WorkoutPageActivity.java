...
public class WorkoutPageActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        // setting up currently selected item in nav bar
        ((BottomNavigationView) findViewById(R.id.bottomNavigation)).setSelectedItemId(R.id.workout);
        // registering this activity when user comes first time or returns
        networkManager.registerConnectionObserver(this,findViewById(R.id.workoutScreen));
